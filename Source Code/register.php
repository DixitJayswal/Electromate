...
if($con){
    if (isset($_POST['add'])) {
        ...
        // $carname = mysqli_real_escape_string($con, $_POST['type']);
        // $companyname = mysqli_real_escape_string($con, $_POST['professional']);
        ...
        if (count($errors) == 0) {
            ...
            $register = "INSERT INTO user (Name, Date, Email, Password)
                    VALUES('$username', '$date_data','$email', '$pwd')";
