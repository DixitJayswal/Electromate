...
<head>
    ...
    <style>
        body {
            ...
            height: 100vh;
            margin: -20px 0 50px;
            background: linear-gradient(90deg, #ff8f00, #DDAF49);
        }
        ...
        * {
        ...
        .overlay {
            background: url(https://www.windowscentral.com/sites/wpcentral.com/files/styles/w1600h900crop/public/field/image/2019/06/lenovo-ideapad-s940-hero.jpg?itok=kWZO2JwO), linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5));
    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="register.php" method="post">
                ...
                <!-- <input type="textarea" placeholder="Location" name="address" />
                <input type="text" placeholder="User or Professional" name="type" />
                <input type="text" placeholder="Type of Professional" name="professional" /> -->
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    <br>
                    <h1>Hello, Welcome to Electromate!</h1>
                    <p>You're just one step away. Find all your Solutions under One Roof</p>
